...
(function () {
  const REGISTRY = [
    ...
    { key: "top.hero.ctaRanking", page: "top", label: "Heroボタン：Editor's Picksを見る", type: "text", default: "今選びたいものを見る" },
    ...
    { key: "top.ranking.eyebrow", page: "top", label: "Editor's Picks見出し上部ラベル", type: "text", default: "Editor's Picks" },
    { key: "top.ranking.title", page: "top", label: "Editor's Picks見出し", type: "text", default: "今、選びたいもの" },
    { key: "top.ranking.more", page: "top", label: "Editor's Picks：もっと見るリンク", type: "text", default: "もっと見る" },
    { key: "top.ranking.cta", page: "top", label: "Editor's Picksカード：CTAボタン", type: "text", default: "詳しく見る" },
